...
public partial class Company_RegistPage : Page
{
    ...
    private async void BtnSave_Click(object sender, RoutedEventArgs e)
    {
        ...
        // Debug.WriteLine($"[Company_RegistPage] 거래처 등록 요청: CompName={tbNew.CompName}");
    ...
    private async void BtnSearch_Click(object sender, RoutedEventArgs e)
    {
        ...
        // if (bUsing == null && string.IsNullOrWhiteSpace(sTradeType) && string.IsNullOrWhiteSpace(TBoxSearch_CompName.Text))
        // {
        ...
        // Debug.WriteLine($"[Company_RegistPage] 거래처 검색: CompName={TBoxSearch_CompName.Text}, TradeType={sTradeType}, Using={bUsing}");

        // PostgResult_TbCompanyList result = await s_SrGClient.SrResult_Company_SelectRowsAsync_CenterCode_CompName_TradType_Using(
        // TBoxSearch_CompName.Text, sTradeType, bUsing);
...
//         tb.Lon = 0; // TODO: 위치 정보 추가 필요
//         tb.Lat = 0; // TODO: 위치 정보 추가 필요
...
//         // ComboBox 설정 - DiscountType, TradeType 등은 실제 값으로 설정 필요
//         // TODO: 실제 값 매핑 구현 필요
