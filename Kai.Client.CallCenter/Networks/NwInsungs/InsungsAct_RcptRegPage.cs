...
// 
    ...
    //        for (int i = 0; i < c_nRepeatNormal; i++) // 10초 동안 대기
    //        {
...
// 
    ...
    //                i == c_nRepeatVeryShort, i == c_nRepeatVeryShort, i == c_nRepeatVeryShort);
// 
    //            if (StdConvert.NullableBoolToBool(resultNulBool.bResult)) break;
// 
    //            if (i == c_nRepeatVeryShort)
    //                return CommonFuncs_StdResult.ErrMsgResult_Error(
...
//                 IntPtr hWndMenu = IntPtr.Zero;
//                 for (int i = 0; i < c_nRepeatNormal; i++) // 2초 대기
//                 {
...
// 
//                 for (int i = 0; i < c_nRepeatVeryShort; i++) // 1초 대기
//                 {
//                     await Task.Delay(c_nWaitNormal);
