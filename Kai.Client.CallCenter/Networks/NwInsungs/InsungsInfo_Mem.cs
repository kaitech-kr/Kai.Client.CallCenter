...
public class InsungsInfo_Mem
{
    ...
    //    // TopWnd
    //    public IntPtr TopWnd_hWnd;  // hWnd 
    //    public Draw.Rectangle TopWnd_rcAbs; // Bound

    //    // ListSonWnd
    //    //public List<StdCommon32_WndInfo> WndInfoList;
    //    public IntPtr hWndChkBoxTotal; // CheckBox - 전체선택
    //    public IntPtr hWndGroupBoxUse; // GroupBox - 사용여부
    //    public IntPtr hWndBtnSerach;   // 버튼 - 조회
