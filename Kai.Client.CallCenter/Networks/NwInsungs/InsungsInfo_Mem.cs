...
public class InsungsInfo_Mem
{
    ...
    public class RcptWnd_Common
    {
        ...
        {
            // Header
            Header_hWnd오더상태 = Std32Window.GetWndHandle_FromRelDrawPt(TopWnd_hWnd, fInfo.접수등록Wnd_Header_오더상태_ptChkRelT);

            // 의뢰지
            의뢰자_hWnd의뢰자Top = Std32Window.GetWndHandle_FromRelDrawPt(TopWnd_hWnd, fInfo.접수등록Wnd_의뢰자_의뢰자_ptChkRelT);
            의뢰자_hWnd고객명 = Std32Window.GetWndHandle_FromRelDrawPt(TopWnd_hWnd, fInfo.접수등록Wnd_의뢰자_고객명_ptChkRelT);
            의뢰자_hWnd동명 = Std32Window.GetWndHandle_FromRelDrawPt(TopWnd_hWnd, fInfo.접수등록Wnd_의뢰자_동명_ptChkRelT);
            의뢰자_hWnd전화1 = Std32Window.GetWndHandle_FromRelDrawPt(TopWnd_hWnd, fInfo.접수등록Wnd_의뢰자_전화1_ptChkRelT);
            의뢰자_hWnd전화2 = Std32Window.GetWndHandle_FromRelDrawPt(TopWnd_hWnd, fInfo.접수등록Wnd_의뢰자_전화2_ptChkRelT);
            의뢰자_hWnd부서 = Std32Window.GetWndHandle_FromRelDrawPt(TopWnd_hWnd, fInfo.접수등록Wnd_의뢰자_부서_ptChkRelT);
            의뢰자_hWnd담당 = Std32Window.GetWndHandle_FromRelDrawPt(TopWnd_hWnd, fInfo.접수등록Wnd_의뢰자_담당_ptChkRelT);
            의뢰자_hWnd주소 = Std32Window.GetWndHandle_FromRelDrawPt(TopWnd_hWnd, fInfo.접수등록Wnd_의뢰자_주소_ptChkRelT);
            의뢰자_hWnd위치 = Std32Window.GetWndHandle_FromRelDrawPt(TopWnd_hWnd, fInfo.접수등록Wnd_의뢰자_위치_ptChkRelT);
            의뢰자_hWnd적요 = Std32Window.GetWndHandle_FromRelDrawPt(TopWnd_hWnd, fInfo.접수등록Wnd_의뢰자_적요_ptChkRelT);

            // 출발지
            출발지_hWnd출발지Top = Std32Window.GetWndHandle_FromRelDrawPt(TopWnd_hWnd, fInfo.접수등록Wnd_출발지_출발지_ptChkRelT);
            출발지_hWnd고객명 = Std32Window.GetWndHandle_FromRelDrawPt(TopWnd_hWnd, fInfo.접수등록Wnd_출발지_고객명_ptChkRelT);
            출발지_hWnd동명 = Std32Window.GetWndHandle_FromRelDrawPt(TopWnd_hWnd, fInfo.접수등록Wnd_출발지_동명_ptChkRelT);
            출발지_hWnd전화1 = Std32Window.GetWndHandle_FromRelDrawPt(TopWnd_hWnd, fInfo.접수등록Wnd_출발지_전화1_ptChkRelT);
            출발지_hWnd전화2 = Std32Window.GetWndHandle_FromRelDrawPt(TopWnd_hWnd, fInfo.접수등록Wnd_출발지_전화2_ptChkRelT);
            출발지_hWnd부서 = Std32Window.GetWndHandle_FromRelDrawPt(TopWnd_hWnd, fInfo.접수등록Wnd_출발지_부서_ptChkRelT);
            출발지_hWnd담당 = Std32Window.GetWndHandle_FromRelDrawPt(TopWnd_hWnd, fInfo.접수등록Wnd_출발지_담당_ptChkRelT);
            출발지_hWnd주소 = Std32Window.GetWndHandle_FromRelDrawPt(TopWnd_hWnd, fInfo.접수등록Wnd_출발지_주소_ptChkRelT);
            출발지_hWnd위치 = Std32Window.GetWndHandle_FromRelDrawPt(TopWnd_hWnd, fInfo.접수등록Wnd_출발지_위치_ptChkRelT);

            // 도착지
            도착지_hWnd도착지Top = Std32Window.GetWndHandle_FromRelDrawPt(TopWnd_hWnd, fInfo.접수등록Wnd_도착지_도착지_ptChkRelT);
            도착지_hWnd고객명 = Std32Window.GetWndHandle_FromRelDrawPt(TopWnd_hWnd, fInfo.접수등록Wnd_도착지_고객명_ptChkRelT);
            도착지_hWnd동명 = Std32Window.GetWndHandle_FromRelDrawPt(TopWnd_hWnd, fInfo.접수등록Wnd_도착지_동명_ptChkRelT);
            도착지_hWnd전화1 = Std32Window.GetWndHandle_FromRelDrawPt(TopWnd_hWnd, fInfo.접수등록Wnd_도착지_전화1_ptChkRelT);
            도착지_hWnd전화2 = Std32Window.GetWndHandle_FromRelDrawPt(TopWnd_hWnd, fInfo.접수등록Wnd_도착지_전화2_ptChkRelT);
            도착지_hWnd부서 = Std32Window.GetWndHandle_FromRelDrawPt(TopWnd_hWnd, fInfo.접수등록Wnd_도착지_부서_ptChkRelT);
            도착지_hWnd담당 = Std32Window.GetWndHandle_FromRelDrawPt(TopWnd_hWnd, fInfo.접수등록Wnd_도착지_담당_ptChkRelT);
            도착지_hWnd주소 = Std32Window.GetWndHandle_FromRelDrawPt(TopWnd_hWnd, fInfo.접수등록Wnd_도착지_주소_ptChkRelT);
            도착지_hWnd위치 = Std32Window.GetWndHandle_FromRelDrawPt(TopWnd_hWnd, fInfo.접수등록Wnd_도착지_위치_ptChkRelT);

            // 예약, SMS, 적요, 공유...
            우측상단_hWnd적요 = Std32Window.GetWndHandle_FromRelDrawPt(TopWnd_hWnd, fInfo.접수등록Wnd_우측상단_적요_ptChkRelT);
            //우측상단_hWnd공유 = Std32Window.GetWndHandle_FromRelDrawRect(TopWnd_hWnd, fInfo.접수등록Wnd_우측상단_공유_rcChkRelT);
            //우측상단_hWnd계산서 = Std32Window.GetWndHandle_FromRelDrawRect(TopWnd_hWnd, fInfo.접수등록Wnd_우측상단_계산서_rcChkRelT);
            ...
            우측상단_hWnd차량톤수 = Std32Window.GetWndHandle_FromRelDrawRect(TopWnd_hWnd, fInfo.접수등록Wnd_우측상단_차량톤수_rcChkRelT);
            우측상단_hWnd트럭상세 = Std32Window.GetWndHandle_FromRelDrawRect(TopWnd_hWnd, fInfo.접수등록Wnd_우측상단_트럭상세_rcChkRelT);
            우측상단_hWnd플럭제외 = Std32Window.GetWndHandle_FromRelDrawRect(TopWnd_hWnd, fInfo.접수등록Wnd_우측상단_플럭제외_rcChkRelT);
            우측상단_hWnd인수증필 = Std32Window.GetWndHandle_FromRelDrawRect(TopWnd_hWnd, fInfo.접수등록Wnd_우측상단_인수증필_rcChkRelT);

            // 요금
            요금그룹_hWnd기본요금 = Std32Window.GetWndHandle_FromRelDrawRectCenter(TopWnd_hWnd, fInfo.접수등록Wnd_요금그룹_기본요금_rcChkRelT);
            요금그룹_hWnd추가금액 = Std32Window.GetWndHandle_FromRelDrawRectCenter(TopWnd_hWnd, fInfo.접수등록Wnd_요금그룹_추가금액_rcChkRelT);
            요금그룹_hWnd할인금액 = Std32Window.GetWndHandle_FromRelDrawRectCenter(TopWnd_hWnd, fInfo.접수등록Wnd_요금그룹_할인금액_rcChkRelT);
            요금그룹_hWnd탁송료 = Std32Window.GetWndHandle_FromRelDrawRectCenter(TopWnd_hWnd, fInfo.접수등록Wnd_요금그룹_탁송료_rcChkRelT);

            // 기사
            기사그룹_hWnd기사번호 = Std32Window.GetWndHandle_FromRelDrawRectCenter(TopWnd_hWnd, fInfo.접수등록Wnd_기사그룹_기사번호_rcChkRelT);
            기사그룹_hWnd기사이름 = Std32Window.GetWndHandle_FromRelDrawRectCenter(TopWnd_hWnd, fInfo.접수등록Wnd_기사그룹_기사이름_rcChkRelT);
            기사그룹_hWnd기사소속 = Std32Window.GetWndHandle_FromRelDrawRectCenter(TopWnd_hWnd, fInfo.접수등록Wnd_기사그룹_기사소속_rcChkRelT);
            //기사그룹_hWnd기사타입 = Std32Window.GetWndHandle_FromRelDrawRectCenter(TopWnd_hWnd, fInfo.접수등록Wnd_기사그룹_기사타입_rcChkRelT);
            기사그룹_hWnd기사전화 = Std32Window.GetWndHandle_FromRelDrawRectCenter(TopWnd_hWnd, fInfo.접수등록Wnd_기사그룹_기사전화_rcChkRelT);
            //기사그룹_hWnd세금계산서 = Std32Window.GetWndHandle_FromRelDrawRectCenter(TopWnd_hWnd, fInfo.접수등록Wnd_기사그룹_세금계산서_rcChkRelT);

            // 오더메모
            우측하단_hWnd오더메모 = Std32Window.GetWndHandle_FromRelDrawPt(TopWnd_hWnd, fInfo.접수등록Wnd_오더메모_ptChkRelT);
        }
    }
    public class RcptWnd_New : RcptWnd_Common
    {
        ...
        public void SetWndHandles(InsungsInfo_File fInfo)
        {
            ...
            Btn_hWnd대기저장 = Std32Window.GetWndHandle_FromRelDrawPt(TopWnd_hWnd, fInfo.접수등록Wnd_신규버튼그룹_대기저장_ptChkRelT);
