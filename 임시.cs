...
public class SrGlobalClient : IDisposable, INotifyPropertyChanged
{
    ...
    public async Task ConnectAsync()
    {
        try
        {
            ...
            HubConn = new HubConnectionBuilder()
                ...
                ////.WithAutomaticReconnect() // 자동 재연결 - 수동으로 사용하므로 주석풀지 말것
                .Build();
    ...
    {
        return await HubConn.InvokeCoreAsync<PostgResult_TbTel070InfoList>(
            StdConst_FuncName.SrResult.CallCenter.Tel070Info_SelectRowsAsync_Charge_NotMainTel, new[] { (object)s_CenterCharge.CenterCode });
    }
    ...
    {
        return await HubConn.InvokeCoreAsync<PostgResult_TbTelMainRingList>(
            StdConst_FuncName.SrResult.Common_TelMainRing_SelectRowsAsync_CenterCode, new[] { (object)s_CenterCharge.CenterCode });
    }
